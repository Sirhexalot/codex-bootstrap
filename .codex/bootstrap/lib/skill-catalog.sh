...
PROJECT_SKILLS_DIR="$PROJECT_ROOT/runtime/skills"
PROJECT_CACHE_DIR="$PROJECT_ROOT/runtime/skills/cache"
PROJECT_STATE_DIR="$PROJECT_ROOT/state/skills"
...
install_frontend_design() {
  ...
  copy_repo() {
    local repo_dir="$1"
    replace_directory "$repo_dir/plugins/frontend-design/.skillsfrontend-design" "$target_dir"
...
install_ui_ux_pro_max() {
  ...
  install_repo_subdir "ui-ux-pro-max" "$mode" "skill" "$repo_url" ".claude/.skillsui-ux-pro-max" ".claude/.skillsui-ux-pro-max"
}

install_drawio_diagrams_enhanced() {
  local mode="$1"
  local repo_url="https://github.com/jgtolentino/insightpulse-odoo.git"
  install_repo_subdir "drawio-diagrams-enhanced" "$mode" "skill" "$repo_url" "docs/claude-code-.skillscommunity/drawio-diagrams-enhanced" "docs/claude-code-.skillscommunity/drawio-diagrams-enhanced"
}
...
install_pptx() {
  ...
  install_repo_subdir "pptx" "$mode" "skill" "$repo_url" ".skillspptx" ".skillspptx"
}

install_senior_architect() {
  local mode="$1"
  local repo_url="https://github.com/alirezarezvani/claude-skills.git"
  install_repo_subdir "senior-architect" "$mode" "skill" "$repo_url" "engineering-team/.skillssenior-architect" "engineering-team/.skillssenior-architect"
}
...
install_infographic_creation() {
  ...
  install_repo_subdir "infographic-creation" "$mode" "skill" "$repo_url" ".skillsinfographic-creator" ".skillsinfographic-creator"
}

install_jira_expert() {
  local mode="$1"
  local repo_url="https://github.com/alirezarezvani/claude-skills.git"
  install_repo_subdir "jira-expert" "$mode" "skill" "$repo_url" "project-management/.skillsjira-expert" "project-management/.skillsjira-expert"
}

install_confluence() {
  local mode="$1"
  local repo_url="https://github.com/alirezarezvani/claude-skills.git"
  install_repo_subdir "confluence" "$mode" "skill" "$repo_url" "project-management/.skillsconfluence-expert" "project-management/.skillsconfluence-expert"
}
